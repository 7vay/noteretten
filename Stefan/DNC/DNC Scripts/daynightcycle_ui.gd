...
@onready var day_label_background: Label = $CenterContainerDay2/DayLabelBackground
@onready var day_label: Label = $CenterContainerDay2/DayLabelBackground/DayLabel
@onready var time_label_background: Label = $CenterContainerTime2/TimeLabelBackground
@onready var time_label: Label = $CenterContainerTime2/TimeLabelBackground/TimeLabel
@onready var arrow: TextureRect = $Arrow2
